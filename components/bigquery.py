...
def create_model(
    ...
    # query_statement_resolved: str
    # if query_statement:
    # query_statement_resolved = query_statement
    # elif source_table_name:
    #     query_statement_resolved = f"""
...
def create_evaluation(
    ...
    thresholds_str: str = "",  # Optional: Blocked by b/198790426 and b/198506675 (supporting lists)
):
